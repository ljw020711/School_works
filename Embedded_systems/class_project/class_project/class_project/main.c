...
void turn_right()
{
	...
	TC3->COUNT16.CC[1].reg = 500;         // mid speed: on duration 600 / 1000
	TC4->COUNT16.CC[1].reg = 500;         // mid speed: on duration 600 / 1000
