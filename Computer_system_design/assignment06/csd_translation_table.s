...
csd_MMUTable:
	 ...
	 *     3rd 1MB: L1 discriptor(Page table) -> L2 page table base address[30:10]
...
.word	SECT + 0x15de6			/* S=b1 TEX=b101 AP=b11, Domain=b1111, C=b0, B=b1 */
.set	SECT, SECT + 0x200000
.extern csd_MMUTable_l2			// get address of csd_MMUTable_l2
.word	csd_MMUTable_l2 + 0x001	// l2 table base address + last 2bit = b01
.set	SECT, SECT - 0x200000
.word	SECT + 0x15de6			/* S=b1 TEX=b101 AP=b11, Domain=b1111, C=b0, B=b1 */
...
.rept (0x200 - 6)				// fill reset 4090 entries
.word	SECT + 0x15de6			/* S=b1 TEX=b101 AP=b11, Domain=b1111, C=b0, B=b1 */
.endr
